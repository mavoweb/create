...
export default grapesjs.plugins.add('gjs-mavo', (editor, opts = {}) => {
  ...
  let defaults = {
    ...
    blocks: ['column1', 'section', 'ordered-list', 'unordered-list', 'list-item', 'column2', 'column3', 'column3-7', 'divider', 'text', 'link', 'image', 'video', 'map', 'link-block', 'quote', 'text-basic', 'form', 'input', 'textarea', 'select', 'button', 'label', 'checkbox', 'radio'],
    ...
    labelVideo: 'Video',
    labelMap: 'Map',
    categoryColumn1: 'Tables',
    categoryColumn2: 'Tables',
    categoryColumn3: 'Tables',
    categoryColumn37: 'Tables',
    categoryDivider: 'Content',
