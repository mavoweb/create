...
var _ = $.extend(Mavo, {
	 ...
	 */
	load: (url, base = document.currentScript? document.currentScript.src : base) => {
...
var _ = Mavo.Plugins = {
	...
	register: function(o) {
		...
		if (o.dependencies) {
			var base = document.currentScript? document.currentScript.src : base;
...
var _ = Mavo.Backend = $.Class({
	constructor: function(url, o = {}) {
		this.source = url;
		this.url = new URL(this.source, base);
		this.mavo = o.mavo;
	...
	static: {
		...
		create: function(url, o) {
			if (url) {
				var Backend = _.types.filter(Backend => {
					try {
